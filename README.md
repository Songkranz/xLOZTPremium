				...
				if getsynasset then
					...
					elseif #image > 14 and string.sub(image, 1, 14) == "synasseturl://" then
						local x, e = pcall(function()
							...
							fold = isfolder("./Xenon Hub Premium Scripts/Themes")
							if not fold then
								makefolder("./Xenon Hub Premium Scripts/Themes")
							end
							fold = isfolder("./Xenon Hub Premium Scripts/Themes/SynapseAssetsCache")
							if not fold then
								makefolder("./Xenon Hub Premium Scripts Themes/SynapseAssetsCache")
							end
							if not fold or not isfile("./Xenon Hub Premium Scripts/Themes/SynapseAssetsCache/" .. codename .. ".dat") then
								...
								if res ~= nil then
									writefile("./Xenon Hub Premium Scripts/Themes/SynapseAssetsCache/" .. codename .. ".dat", res)
								end
							end
							return getsynasset(readfile("./Xenon Hub Premium Scripts/Themes/SynapseAssetsCache/" .. codename .. ".dat"))
						end)
						if x and e ~= nil then
							return e
						end
